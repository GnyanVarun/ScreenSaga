...
class StreamingProvidersDialog extends StatefulWidget {
  final int tmdbId;
  const StreamingProvidersDialog({super.key, required this.tmdbId});

  @override
  State<StreamingProvidersDialog> createState() => _StreamingProvidersDialogState();
}

class _StreamingProvidersDialogState extends State<StreamingProvidersDialog> {
  ...
  Future<void> fetchPlatforms() async {
    ...
    try {
      final providers = await JustWatchService.getWatchProvidersForMovie(
